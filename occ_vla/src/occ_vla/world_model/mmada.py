...
class MMaDAWorldModel:
    ...
    def load(self) -> None:
        ...
        self._uni_prompting = UniversalPrompting(text_tokenizer, max_seq_len=SUBGOAL_NUM_TOKENS + 8)
    ...
    def build_prompt(self, text: str, image_ids: torch.LongTensor) -> MaskedTokenBatch:
        ...
        be (re)generated, real MAGVIT-v2 codes elsewhere."""
        ...
        return MaskedTokenBatch(input_ids=input_ids, attention_mask=attention_mask)
